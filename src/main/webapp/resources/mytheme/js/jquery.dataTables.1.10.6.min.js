...
(/** @lends <global> */function( $ ) {
	...
	function _fnBuildFilter ( settings )
	{
		var columns = settings.aoColumns;
		var filter = {};
		for ( var i=0, iLen=columns.length ; i<iLen ; i++ )
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		str = str.match(/_INPUT_/) ?
			...
			str+input;
		var filterOnColumn = _fnBuildFilter( settings);
		var obj = jQuery.parseJSON(filterOnColumn);
		var options = "";
		
		for ( var key in obj) {
						var attrName = key;
						var attrValue = obj[key];
						var columnDisplay = attrValue ? "checked" : "";
						options = options + "<li><b><label><input class= \"filterCtrl\" type=\"checkbox\" checked=\""+columnDisplay+"\" name=\""+attrName+"\">"+attrName+"</label></b></li>";		
					}
					
					
		options = "<br><ul style=\" text-align: left; width: auto; color: white; list-style-type: none; background-color: #007399; display: none; position: absolute; z-index: 1000;\" id="+tableId+"_columnUl>" + options + "</ul>";			
		var filterControlLink = "&nbsp;&nbsp;<a onclick='javascript:$( \"#"+tableId+"_columnUl\" ).toggle();'><b>Filter</b></a>&nbsp;&nbsp;"+options;
		var filter = $('<div/>', {
				'id': ! features.f ? tableId+'_filter' : null,
				'class': classes.sFilter
			} )
			.append( $('<label/>' ).append( str + filterControlLink ) );
