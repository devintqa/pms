  ...
  $(document).ready(function () {
		$("#aliasProjectName").autocomplete({
			source: function (request, response) {
				$.getJSON("/pms/emp/myview/searchSubProject/searchProject.do", {
	                term: request.term
	            }, response);
	        }
		});
...
<body ng-app="sampleApp">
 ...
 <div class="ui-widget">
			<form:form id="searchSubForm" method="POST" commandName="searchSubForm"
				action="searchSubProjectDetails.do">
				<center>
