...
<head>
    <meta charset="utf-8">
    <title>PMS :: View Stock Details</title>
...
<div id="wrapper">
    ...
    <div class="ui-widget">
        <form:form id="stockDetailForm" method="POST"
                   commandName="stockDetailForm"
                   action="viewStockDetails.do">
            <center>
        ...
        <c:if test="${stockDetailsSize gt 0}">
            ...
            <table id="aggregateItemList" class="gridView">
                ...
                <tbody>
                <c:if test="${not empty stockDetails}">
                    <c:forEach var="item" items="${stockDetails}">
                        <tr>
                            <td>${item.itemName}</td>
