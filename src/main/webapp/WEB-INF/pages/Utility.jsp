...
<script>
    $(function() {
        ...
        var table = $('#indentList').DataTable({
        	"scrollY":        "500px",
            "scrollCollapse": true,
            "paging": false
        });

        $("#indentList_columnUl").on('change', 'input:checkbox', function(e) {
            var columnName = $(this).attr('name');
            ...
            $("div[id*=indentList_wrapper] table").each(function() {
               console.log(this);
             })
             
            var tables = $("div[id*=indentList_wrapper] table");
            if(tables.length > 0){
	            $(tables[0]).find('th').each(function(index, item) {
	            	 if (columnName == item.innerHTML) {
	                     $('table[id*=indentList] tr').find("th:eq(" + index + "), td:eq(" + index + ")").toggle();
	                     $(this).toggle();
	                 }
	            });
            }
...
<script>
    $(function() {
        ...
        var table = $('#supplierDetails').DataTable({
        	"scrollY":        "500px",
            "scrollCollapse": true,
            "paging": false
        });

        $("#supplierDetails_columnUl").on('change', 'input:checkbox', function(e) {
            var columnName = $(this).attr('name');
            ...
            $("div[id*=supplierDetails_wrapper] table").each(function() {
               console.log(this);
             })

            var tables = $("div[id*=supplierDetails_wrapper] table");
            if(tables.length > 0){
	            $(tables[0]).find('th').each(function(index, item) {
	            	 if (columnName == item.innerHTML) {
	                     $('table[id*=supplierDetails] tr').find("th:eq(" + index + "), td:eq(" + index + ")").toggle();
	                     $(this).toggle();
	                 }
	            });
            }
...
<script>
    $(function() {
        ...
        $("#purchaseList_columnUl").on('change', 'input:checkbox', function(e) {
            var columnName = $(this).attr('name');
            ...
            $("div[id*=purchaseList_wrapper] table").each(function() {
               console.log(this);
             })
             
            var tables = $("div[id*=purchaseList_wrapper] table");
            if(tables.length > 0){
	            $(tables[0]).find('th').each(function(index, item) {
	            	 if (columnName == item.innerHTML) {
	                     $('table[id*=purchaseList] tr').find("th:eq(" + index + "), td:eq(" + index + ")").toggle();
	                     $(this).toggle();
	                 }
	            });
            }
...
<script>
    $(function() {
        ...
        var table = $('#purchaseListForPayment').DataTable({
        	"scrollY":        "500px",
            "scrollCollapse": true,
            "paging": false
        });

        $("#purchaseListForPayment_columnUl").on('change', 'input:checkbox', function(e) {
            var columnName = $(this).attr('name');
            ...
            $("div[id*=purchaseListForPayment_wrapper] table").each(function() {
               console.log(this);
             })
             
            var tables = $("div[id*=purchaseListForPayment_wrapper] table");
            if(tables.length > 0){
	            $(tables[0]).find('th').each(function(index, item) {
	            	 if (columnName == item.innerHTML) {
	                     $('table[id*=purchaseListForPayment] tr').find("th:eq(" + index + "), td:eq(" + index + ")").toggle();
	                     $(this).toggle();
	                 }
	            });
            }
