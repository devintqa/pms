        ...
        $(document).ready(function () {
            ...
            $("#itemType").change(function () {
                ...
                $.ajax({
                    ...
                    url: "getItemNames.do",
                    cache: false,
                    data: "itemType=" + itemType + "&projId=" + projId + "&employeeId=" + employeeId,
...
<div id="wrapper">
    ...
    <div>
        <form:form method="POST" commandName="storeDetailForm" action="saveStoreDetail.do">
            <center>
                <fieldset style="margin: 1em; text-align: left;">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><form:errors path="vehicleNumber"
                                             cssClass="error"/></td>
                        </tr>
                        <tr>
                            ...
                            <td><form:errors path="recievedQuantity"
                                             cssClass="error"/></td>
                        </tr>
                        <tr>
                            <td>Recieved Date<span id="colon">:</span>
                            </td>
                            <td><form:input path="recievedDate" placeholder="DD-MM-YYYY"
                        ...
                        <tr>
                            ...
                            <td><form:textarea path="comments"
                                               placeholder="Enter Comments" cssClass="inputText"
