...
public class ProjectDescriptionDetailBuilder {
	...
	private static final Logger LOGGER = Logger
			.getLogger(ProjectDescriptionDetailBuilder.class);

	public List<ProjDescDetail> buildDescDetailList(String saveDirectory,
			MultipartFile multipartFile, String sheetName) {
					...
					while (cellIterator.hasNext()) {
						...
						case Cell.CELL_TYPE_STRING:
							...
							if (cell.getColumnIndex() == 1)
								projDescDetail.setWorkType(cell
										.getStringCellValue());
