...
public class PmsMasterQuery {
    ...
    public static final String CREATE_DISPATCH_DETAILS = "insert into dispatchdetail(projectId, itemName, dispactchedDate,fieldUser,dispatchDesc,quantity) values (?,?,?,?,?,?)";
