...
public class ExcelViewController extends BaseController {
	...
	private static final Logger LOGGER = Logger.getLogger(ExcelViewController.class);
	...
	@ResponseBody 
	public String saveEdition(@PathVariable String empId, @RequestBody String edition) {
